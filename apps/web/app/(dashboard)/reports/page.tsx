    ...
    return (
      <div className="flex h-full items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-1">Chọn cơ sở y tế để xem báo cáo</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Phân tích dữ liệu kho thuốc tại {currentCenter.name}</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-lg border p-4 space-y-4">
          <h2 className="font-semibold">Dự báo hết hạn</h2>
          {expiryChartData.length > 0 ? (
            ...
            <div className="flex h-[300px] items-center justify-center text-sm text-muted-foreground">
              Không có dữ liệu hết hạn trong 90 ngày tới
            </div>
          )}
        </div>
        ...
        <div className="rounded-lg border p-4 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="font-semibold">Top thuốc tiêu thụ</h2>
